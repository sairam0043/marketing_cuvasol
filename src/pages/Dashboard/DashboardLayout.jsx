...
export function DashboardLayout({ activeTab, onTabChange, onNavigateLanding }) {
    ...
    <div className="dashboard-layout">
      ...
      <aside className={`dash-sidebar ${mobileSidebarOpen ? 'mobile-open' : ''}`}>
        <div className="sidebar-header">
          <a href="#landing" onClick={(e) => { e.preventDefault(); onNavigateLanding(); }} className="brand-logo" style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', textDecoration: 'none' }}>
            <img src="/assets/logo.png" alt="Cuvasol" style={{ height: 34, width: 34, objectFit: 'contain' }} />
        ...
        <nav className="sidebar-nav">
          ...
          >
            ...
            <span className="nav-pill-count">{campaigns.length} Active</span>
          </button>
          <button
