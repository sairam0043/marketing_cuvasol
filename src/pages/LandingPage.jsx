  ...
  return (
    <div className="landing-page-root" style={{ minHeight: '100vh', background: 'var(--bg-primary)', color: 'var(--text-primary)' }}>
      ...
      {/* =========================================================================
         SECTION: FAQ
         ========================================================================= */}
      <section id="faq" style={{ padding: '5.5rem 0', background: 'var(--bg-secondary)', borderTop: '1px solid var(--border-subtle)' }}>
        <div className="container">
          <div style={{ textAlign: 'center', maxWidth: 750, margin: '0 auto 3.5rem auto' }}>
            <div style={{ color: 'var(--primary)', fontSize: '0.85rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.5rem' }}>
              FAQ
            </div>
            <h2 style={{ fontSize: '2.4rem', fontFamily: 'var(--font-display)', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '0.75rem' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '1.05rem' }}>
              Find quick answers to common questions about the referral program.
            </p>
          </div>
          ...
          <div style={{ maxWidth: 880, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            {[
              {
                q: 'How much do I earn per successful student referral?',
                a: 'You earn ₹500 for every eligible student who registers on Cuvasol Tutor using your personal referral code.'
              },
              {
                q: 'Is there any fee to join as a Referral Agent?',
                a: 'No! Registration is 100% free with zero signup fees or hidden charges.'
              },
              {
                q: 'How do I get my unique referral code?',
                a: 'Once you create your free agent account, your personalized referral code and sharing link will be generated automatically in your dashboard.'
              },
              {
                q: 'Who can I refer to Cuvasol Tutor?',
                a: 'Anyone looking for quality tutors! This includes school students, college students, language learners, coding enthusiasts, and competitive exam aspirants.'
              },
              {
                q: 'When and how are earnings paid?',
                a: 'Once the referred student fulfills program eligibility criteria, your ₹500 reward is credited to your agent account and processed according to payment terms.'
              }
            ].map((faq, idx) => (
              <div key={idx} className="glass-card" style={{ padding: '1.75rem 2rem', borderRadius: '18px' }}>
                <h3 style={{ fontSize: '1.15rem', fontFamily: 'var(--font-sans)', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '0.5rem', display: 'flex', alignItems: 'center', gap: '0.65rem' }}>
                  <span style={{ color: 'var(--primary)' }}>❓</span> {faq.q}
                </h3>
                <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', lineHeight: 1.6, paddingLeft: '1.85rem' }}>
                  {faq.a}
                </p>
              </div>
            ))}
      ...
      {/* =========================================================================
         SECTION: CONTACT US
         ========================================================================= */}
      <section id="contact-us" style={{ padding: '5.5rem 0', borderTop: '1px solid var(--border-subtle)' }}>
        <div className="container">
          <div style={{ textAlign: 'center', maxWidth: 750, margin: '0 auto 3.5rem auto' }}>
            <div style={{ color: 'var(--primary)', fontSize: '0.85rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.5rem' }}>
              Contact Us
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '1.05rem' }}>
              Have questions or need support with your referral account? We are here to help!
            </p>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2.5rem', maxWidth: 1000, margin: '0 auto' }}>
            ...
            <div className="glass-card" style={{ padding: '2.5rem', borderRadius: '24px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <div>
                <h3 style={{ fontSize: '1.4rem', fontFamily: 'var(--font-sans)', fontWeight: 700, marginBottom: '1.25rem', color: 'var(--text-primary)' }}>
                  Contact Information
                </h3>
                
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', marginBottom: '2rem' }}>
                  <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                    <div style={{ fontSize: '1.5rem', background: 'var(--primary-light)', padding: '0.6rem', borderRadius: '12px' }}>📧</div>
                    <div>
                      <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', fontWeight: 600 }}>Email Support</div>
                      <div style={{ fontWeight: 700, color: 'var(--text-primary)', fontSize: '0.95rem' }}>support@cuvasol.com</div>
                    </div>
                  </div>

                  <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                    <div style={{ fontSize: '1.5rem', background: 'var(--accent-light)', padding: '0.6rem', borderRadius: '12px' }}>📍</div>
                    <div>
                      <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', fontWeight: 600 }}>Headquarters</div>
                      <div style={{ fontWeight: 700, color: 'var(--text-primary)', fontSize: '0.95rem' }}>Cuvasol Referral Cloud, India</div>
                    </div>
                  </div>

                  <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                    <div style={{ fontSize: '1.5rem', background: 'var(--grow-bg)', padding: '0.6rem', borderRadius: '12px' }}>🕒</div>
                    <div>
                      <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', fontWeight: 600 }}>Support Hours</div>
                      <div style={{ fontWeight: 700, color: 'var(--text-primary)', fontSize: '0.95rem' }}>Mon - Sat: 9:00 AM - 6:00 PM IST</div>
                    </div>
                  </div>
                </div>
              </div>

              <div style={{ padding: '1.25rem', borderRadius: '16px', background: 'var(--bg-secondary)', border: '1px solid var(--border-subtle)', fontSize: '0.875rem', color: 'var(--text-secondary)' }}>
                💡 Quick Tip: Log in to your agent dashboard for real-time referral tracking and instant payouts.
              </div>
            </div>
            ...
            <div className="glass-card" style={{ padding: '2.5rem', borderRadius: '24px' }}>
              ...
              <form onSubmit={(e) => { e.preventDefault(); alert('Thank you for reaching out! Our team will get back to you shortly.'); }}>
                <div style={{ marginBottom: '1.25rem' }}>
                  <label htmlFor="contact-name" style={{ display: 'block', fontSize: '0.875rem', fontWeight: 600, color: 'var(--text-primary)', marginBottom: '0.4rem' }}>Your Name</label>
                  <input id="contact-name" type="text" required placeholder="Enter your full name" className="form-control" />
                </div>

                <div style={{ marginBottom: '1.25rem' }}>
                  <label htmlFor="contact-email" style={{ display: 'block', fontSize: '0.875rem', fontWeight: 600, color: 'var(--text-primary)', marginBottom: '0.4rem' }}>Email Address</label>
                  <input id="contact-email" type="email" required placeholder="name@example.com" className="form-control" />
                </div>

                <div style={{ marginBottom: '1.5rem' }}>
                  <label htmlFor="contact-msg" style={{ display: 'block', fontSize: '0.875rem', fontWeight: 600, color: 'var(--text-primary)', marginBottom: '0.4rem' }}>Message</label>
                  <textarea id="contact-msg" rows="4" required placeholder="How can we help you?" className="form-control" style={{ resize: 'vertical' }}></textarea>
                </div>
